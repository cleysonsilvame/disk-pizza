...
if($acao == 'insert'){
  ...
  $numero = $_POST['inputTelefone'];
  $endereco = $_POST['inputEndereco'];

  $sql = "INSERT INTO tb_cliente (telefone_cliente, endereco_cliente)values('$numero', '$endereco')";
      ...
      <main class='d-block h-100 bg-secondary'>
        ...
        <div class='main-content'>
          <div class='main-content p-3 w-100'>
            ...
            <form action='cadastrar-cliente.php?acao=insert' method='POST' class='container'>
            <div class='form-row mt-5'>
              <div class='form-group col-md-4'>
                <label for='inputTelefone'>Telefone</label>
                <input type='text' class='form-control' id='inputTelefone' name='inputTelefone' placeholder='(DDD) 9 9999-9999' maxlength='13' required onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
              </div>
              <div class='form-group col-md-8'>
                <label for='inputEndereco'>Endereço</label>
                <input type='text' class='form-control' id='inputEndereco' name='inputEndereco' placeholder='Av. Fulando de tal, 999 - Bairro - Cidade/Sigla' maxlength='80' required>
              </div>
            </div>
