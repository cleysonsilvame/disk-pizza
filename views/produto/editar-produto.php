...
while ($registro = mysqli_fetch_array($resultado)) {
    ...
    $view .= "
              <tr>
                ...
                <td>" . $tipo . "</td>
                <td>
                  <a href='/views/produto/update-produto.php?inputCodigo=$id' class='btn text-dark'><i class='fas fa-edit'></i></a>
                  <a href='/views/produto/delete-produto.php?inputCodigo=$id' class='btn text-dark'><i class='fas fa-trash'></i></a>
                </td>
              </tr>";
}
mysqli_close($link);
    ...
    <div class="flex-dashboard d-flex flex-row h-100 w-100">
        <sidebar class="h-100 bg-dark text-light">
            ...
            <ul class="nav nav-pills flex-column p-4">
                ...
                <li class="nav-item">
                    <a href="/views/produto/editar-produto.php" class="nav-link text-light active"><i class="fas fa-utensils"></i> Editar Produtos</a>
                </li>
            </ul>
        </sidebar>
