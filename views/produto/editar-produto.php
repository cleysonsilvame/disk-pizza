...
while ($registro = mysqli_fetch_array($resultado)) {
    ...
    $view .= "
              <tr>
                ...
                <td>" . $tipo . "</td>
                <td>
                  <a href='/views/produto/update-produto.php?inputCodigo=$id' class='btn text-dark m-2'><i class='fas fa-edit'></i></a>
                  <a href='/views/produto/delete-produto.php?inputCodigo=$id' class='btn text-dark m-2'><i class='fas fa-trash'></i></a>
                </td>
              </tr>";
}
mysqli_close($link);
            ...
            <nav class="navbar navbar-dark bg-danger m-0 p-0">
                ...
                <div class="m-0 p-0 flex-fill">
                    <div class="d-flex align-items-center justify-content-center bg-danger text-dark">
                        <h3><i class="fas fa-utensils"></i> Editar Produtos</h3>
                    </div>
                </div>
            </nav>
        </div>
